...
! function(e, t) {
	...
	return function(e) {
		...
		var a = o(1),
			...
			r = o(17),
			l = n(r);
		i["default"].VConsolePlugin = l["default"], t["default"] = i["default"], e.exports = t["default"]
	}, function(e, t, o) {
		"use strict";
		...
		var f = o(10),
			...
			A = function() {
				function e(t) {
					if(i(this, e), v["default"].one(M)) return void console.debug("vConsole is already exists.");
					var o = this;
					...
					void 0 !== document ? "complete" == document.readyState ? a() : v["default"].bind(window, "load", a) : ! function() {
						var e = void 0,
							t = function o() {
								document && "complete" == document.readyState ? (e && clearTimeout(e), a()) : e = setTimeout(o, 1)
							};
						e = setTimeout(t, 1)
					}()
				}
				return r(e, [{
					...
					value: function() {
						...
						this.$dom.addEventListener("touchstart", function(e) {
							if(void 0 === o) {
								...
								n = t.pageX, a = t.pageY, o = e.timeStamp, r = e.target.nodeType === Node.TEXT_NODE ? e.target.parentNode : e.target
							}
						}, !1), this.$dom.addEventListener("touchmove", function(e) {
							var o = e.changedTouches[0];
							(Math.abs(o.pageX - n) > t || Math.abs(o.pageY - a) > t) && (i = !0)
					...
					value: function() {
						...
						v["default"].bind(o, "touchstart", function(e) {
							var t = o.scrollTop,
								a = o.scrollHeight,
								i = t + o.offsetHeight;
							0 === t ? (o.scrollTop = 1, 0 === o.scrollTop && (v["default"].hasClass(e.target, "vc-cmd-input") || (n = !0))) : i === a && (o.scrollTop = t - 1, o.scrollTop === t && (v["default"].hasClass(e.target, "vc-cmd-input") || (n = !0)))
					...
					value: function(e) {
						...
						e.vConsole = this, e.trigger("init"), e.trigger("renderTab", function(o) {
							...
							var a = v["default"].render(m["default"], {
								id: e.id
							});
							o && (d.isString(o) ? a.innerHTML += o : d.isFunction(o.appendTo) ? o.appendTo(a) : d.isElement(o) && a.insertAdjacentElement("beforeend", o)), v["default"].one(".vc-content", t.$dom).insertAdjacentElement("beforeend", a)
						}), e.trigger("addTopBar", function(o) {
							if(o)
								for(var n = v["default"].one(".vc-topbar", t.$dom), a = function(t) {
										var a = o[t],
										...
										d.isFunction(a.onClick) && v["default"].bind(i, "click", function(t) {
							...
							if(o)
								for(var n = v["default"].one(".vc-tool-last", t.$dom), a = function(t) {
										var a = o[t],
											i = v["default"].render(x["default"], {
												name: a.name || "Undefined",
												pluginID: e.id
											});
										1 == a.global && v["default"].addClass(i, "vc-global-tool"), d.isFunction(a.onClick) && v["default"].bind(i, "click", function(e) {
											a.onClick.call(i)
					...
					value: function(e) {
						...
						if(t.trigger("remove"), this.isInited) {
							...
							for(var n = v["default"].all(".vc-topbar-" + e, this.$dom), a = 0; a < n.length; a++) n[a].parentNode.removeChild(n[a]);
		...
		function d(e) {
			return !("[object Object]" != Object.prototype.toString.call(e) && (n(e) || a(e) || r(e) || i(e) || c(e) || u(e) || l(e) || s(e)))
		}
		...
		function b(e) {
			var t = arguments.length <= 1 || void 0 === arguments[1] ? "	" : arguments[1],
				...
				n = [],
				a = JSON.stringify(e, function(e, t) {
		...
		t.getDate = o, t.isNumber = n, t.isString = a, t.isArray = i, t.isBoolean = r, t.isUndefined = l, t.isNull = c, t.isSymbol = s, t.isObject = d, t.isFunction = u, t.isElement = v, t.isWindow = f, t.isPlainObject = p, t.htmlEncode = h, t.JSONStringify = b, t.getObjAllKeys = g, t.getObjName = m, t.setStorage = y, t.getStorage = _
	}, function(e, t, o) {
		"use strict";
		...
		l.one = function(e, t) {
			...
			e && e.addEventListener(t, function(t) {
				var a = l.all(o, e);
				if(a) e: for(var i = 0; i < a.length; i++)
		...
		function o(e, t, o) {
			...
			c(e.substr(r, e.length - r), !1), a += '__mito_result = arr.join("");', a = "with (__mito_data) {\n" + a + "\n}", i += a, i += "})();";
		...
		function s(e, t) {
			...
			if(t.singleton) {
				var i = m++;
				o = g || (g = l(t)), n = d.bind(null, o, i, !1), a = d.bind(null, o, i, !0)
			} else e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (o = c(t), n = v.bind(null, o), a = function() {
				r(o), o.href && URL.revokeObjectURL(o.href)
			}) : (o = l(t), n = u.bind(null, o), a = function() {
				r(o)
			});
			return n(e),
				function(t) {
			...
			_ = function(e) {
				...
				return l(t, e), c(t, [{
					...
					value: function() {
						...
						i.innerHTML = o, i.setAttribute("nonce", a), document.documentElement.appendChild(i), document.documentElement.removeChild(i)
					}
				}, {
					key: "mockConsole",
					value: function() {
					...
					value: function(e) {
						...
						a.innerHTML = t, a.setAttribute("nonce", n), document.documentElement.appendChild(a);
						var i = window.__vConsole_cmd_result,
							r = window.__vConsole_cmd_error;
						if(document.documentElement.removeChild(a), 0 == r) {
							var l = void 0;
							f.isArray(i) || f.isObject(i) ? l = this.getFoldedLine(i) : (f.isNull(i) ? i = "null" : f.isUndefined(i) ? i = "undefined" : f.isFunction(i) ? i = "function()" : f.isString(i) && (i = '"' + i + '"'), l = u["default"].render(y["default"], {
								content: i,
								type: "output"
							})), this.printLog({
								logType: "log",
		...
		var c = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
			...
			k = function(e) {
				...
				return l(t, e), s(t, [{
					...
					key: "onAddTopBar",
					value: function(e) {
						for(var t = this, o = ["All", "Log", "Info", "Warn", "Error"], n = [], a = 0; a < o.length; a++) n.push({
							name: o[a],
							data: {
								type: o[a].toLowerCase()
							},
							className: "",
							onClick: function() {
					...
					value: function() {
						...
						f["default"].bind(t, "click", function(o) {
							...
							f["default"].removeClass(a, "vc-log-partly-log"), f["default"].removeClass(a, "vc-log-partly-info"), f["default"].removeClass(a, "vc-log-partly-warn"), f["default"].removeClass(a, "vc-log-partly-error"), "all" == n ? f["default"].removeClass(a, "vc-log-partly") : (f["default"].addClass(a, "vc-log-partly"), f["default"].addClass(a, "vc-log-partly-" + n))
						});
					...
					value: function(e) {
						...
						if(t.length || e.content) {
							...
							if(a ? o = a == this.id : 0 == this.allowUnformattedLog && (o = !1), !o) return void(e.noOrigin || this.printOriginLog(e));
					...
					value: function(e, t) {
						...
						if(!t) {
							var n = u.JSONStringify(e),
								a = n.substr(0, 26);
							t = u.getObjName(e), n.length > 26 && (a += "..."), t += " " + a
						}
						...
						return f["default"].bind(f["default"].one(".vc-fold-outer", i), "click", function(t) {
							...
							if(0 == n.children.length && e) {
								for(var a = u.getObjAllKeys(e), r = 0; r < a.length; r++) {
									var l = e[a[r]],
										c = "undefined",
										s = "";
									...
									if(u.isArray(l)) {
										...
										e.hasOwnProperty && !e.hasOwnProperty(a[r]) && (s = "private");
										var h = {
											lineType: "kv",
											key: u.htmlEncode(a[r]),
											keyType: s,
			...
			h = function(e) {
				...
				return l(t, e), c(t, [{
					...
					value: function() {
						...
						t = "Unknown", i ? t = "Android " + i[2] : a ? t = "iPhone, iOS " + a[2].replace(/_/g, ".") : n ? t = "iPad, iOS " + n[2].replace(/_/g, ".") : o && (t = "iPod, iOS " + o[2].replace(/_/g, "."));
						var r = t,
							...
							switch(n.responseType) {
								...
								case "text":
									if(v.isString(n.response)) try {
										i.response = JSON.parse(n.response), i.response = JSON.stringify(i.response, null, 1), i.response = v.htmlEncode(i.response)
									} catch(r) {
										i.response = v.htmlEncode(n.response)
									} else "undefined" != typeof n.response && (i.response = Object.prototype.toString.call(n.response));
									break;
								case "json":
									"undefined" != typeof n.response && (i.response = JSON.stringify(n.response, null, 1));
									break;
								case "blob":
								case "document":
								case "arraybuffer":
								default:
									"undefined" != typeof n.response && (i.response = Object.prototype.toString.call(n.response))
							}
							0 == n.readyState || 1 == n.readyState ? i.status = "Pending" : 2 == n.readyState || 3 == n.readyState ? i.status = "Loading" : 4 == n.readyState || (i.status = "Unknown");
					...
					value: function() {
						...
						if(e) {
							...
							t._open = o, t._send = n, window.XMLHttpRequest.prototype.open = function() {
								...
								return e._noVConsole || t.updateRequest(e._requestID, i), n.apply(e, o)
							}
						}
					}
				}, {
			...
			m = function(e) {
				...
				return l(t, e), c(t, [{
					...
					value: function(e, t, o) {
						...
						switch(e.view = a, g["default"].delegate(a, "click", ".vcelm-node", function(t) {
							t.stopPropagation();
							...
							if(!g["default"].hasClass(o, "vcelm-noc")) {
								...
								for(var a = -1, i = 0; i < o.children.length; i++) {
									var r = o.children[i];
									g["default"].hasClass(r, "vcelm-l") && (a++, r.children.length > 0 || (e.childNodes[a] ? n.renderView(e.childNodes[a], r, "replace") : r.style.display = "none"))
								}
							}
						}), o) {
							case "replace":
			...
			g = function() {
				...
				return s(e, [{
					...
					value: function(e, t) {
						...
						var a = b["default"].render(u["default"], {
								node: e
							}),
							i = b["default"].render(f["default"], {
								node: e
							});
						if(n) b["default"].addClass(t, "vcelm-noc"), t.appendChild(a), o || t.appendChild(i);
						else {
							t.appendChild(a);
		...
		var c = function() {
			...
			y = function(e) {
				...
				return l(t, e), c(t, [{
					...
					key: "onAddTopBar",
					value: function(e) {
						for(var t = this, o = ["Cookies", "LocalStorage"], n = [], a = 0; a < o.length; a++) n.push({
							name: o[a],
							data: {
								type: o[a].toLowerCase()
							},
